                                                    ...
                                                    <div className='top-section'>
                                                        ...
                                                        <div className="d-flex flex-row gap-2 align-items-center my-1">
                                                            ...
                                                            <div id="price-section-quickview" className='d-flex flex-row gap-2 align-items-center my-1'>
                                                                {setting.setting && setting.setting.currency}<p id='fa-rupee' className='m-0'>{selectedVariant ? (selectedVariant.discounted_price ==0 ? selectedVariant.price: selectedVariant.discounted_price): (product.variants[0].discounted_price == 0 ? product.variants[0].price: product.variants[0].discounted_price)}</p>
                                                            </div>
                                                        </div>
                                                                        ...
                                                                        return (
                                                                            <>
                                                                                <div className="variant-section col-2">
                                                                                    ...
                                                                                    <div className={`variant-element ${variant_index == index ? 'active' : ''} ${product.is_unlimited_stock ? "" : (variant.cart_count >= variant.stock ?"outOfStock": "")}`} key={index}>
